...
{
    public class SeeingSharpPropertyGridBehavior : Behavior<PropertyGrid>
    {
        /// <summary>
        ...
        protected override void OnAttached()
        {
            ...
            base.AssociatedObject.PropertyControlFactory = new SeeingSharpPropertyControlFactory();
            base.AssociatedObject.PropertyItemFactory = new SeeingSharpPropertyItemFactory();
        }
