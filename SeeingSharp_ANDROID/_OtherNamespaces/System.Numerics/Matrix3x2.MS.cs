...
namespace System.Numerics
{
	...
	public struct Matrix3x2 : IEquatable<Matrix3x2>
	{
		...
		public static Matrix3x2 CreateRotation(float radians)
		{
			...
			{
				if ((double)radians > 1.5707788735010619 && (double)radians < 1.5708137800887312)
				{
					num = 0f;
					num2 = 1f;
				}
				...
				{
					if ((double)radians < -3.1415752002959585 || (double)radians > 3.1415752002959585)
					{
						num = -1f;
						num2 = 0f;
					}
					...
					{
						if ((double)radians > -1.5708137800887312 && (double)radians < -1.5707788735010619)
						{
							num = 0f;
							num2 = -1f;
						}
