...
namespace System.Numerics
{
    ...
    public struct Matrix4x4 : IEquatable<Matrix4x4>
	{
		...
		public static Matrix4x4 CreateConstrainedBillboard(Vector3 objectPosition, Vector3 cameraPosition, Vector3 rotateAxis, Vector3 cameraForwardVector, Vector3 objectForwardVector)
		{
			...
			float value = Vector3.Dot(rotateAxis, vector);
			Vector3 vector2;
			Vector3 vector3;
		...
		//		*(IntPtr*)(ptr3 + (IntPtr)sizeof(Vector3*) / sizeof(Vector3*)) = &identity.M21;
		//		*(IntPtr*)(ptr3 + (IntPtr)2 * (IntPtr)sizeof(Vector3*) / sizeof(Vector3*)) = &identity.M31;
		//		*(*(IntPtr*)ptr3) = new Vector3(matrix.M11, matrix.M12, matrix.M13);
		//		*(*(IntPtr*)(ptr3 + (IntPtr)sizeof(Vector3*) / sizeof(Vector3*))) = new Vector3(matrix.M21, matrix.M22, matrix.M23);
		//		*(*(IntPtr*)(ptr3 + (IntPtr)2 * (IntPtr)sizeof(Vector3*) / sizeof(Vector3*))) = new Vector3(matrix.M31, matrix.M32, matrix.M33);
		//		scale.X = ((IntPtr*)ptr3)->Length();
		//		scale.Y = ((IntPtr*)(ptr3 + (IntPtr)sizeof(Vector3*) / sizeof(Vector3*)))->Length();
		//		scale.Z = ((IntPtr*)(ptr3 + (IntPtr)2 * (IntPtr)sizeof(Vector3*) / sizeof(Vector3*)))->Length();
		//		float num = *ptr2;
		//		float num2 = ptr2[1];
		//		float num3 = ptr2[(IntPtr)2];
		//		uint num4;
		//		uint num5;
		//		uint num6;
		//		if (num < num2)
		...
		//			}
		//		}
		//		if (ptr2[(IntPtr)((ulong)num4 * 4uL) / 4] < 0.0001f)
		//		{
		//			*(*(IntPtr*)(ptr3 + (IntPtr)((ulong)num4 * (ulong)((long)sizeof(Vector3*))) / sizeof(Vector3*))) = ptr4[(IntPtr)((ulong)num4 * (ulong)((long)sizeof(Vector3))) / sizeof(Vector3)];
		//		}
		//		*(*(IntPtr*)(ptr3 + (IntPtr)((ulong)num4 * (ulong)((long)sizeof(Vector3*))) / sizeof(Vector3*))) = Vector3.Normalize(*(*(IntPtr*)(ptr3 + (IntPtr)((ulong)num4 * (ulong)((long)sizeof(Vector3*))) / sizeof(Vector3*))));
		//		if (ptr2[(IntPtr)((ulong)num5 * 4uL) / 4] < 0.0001f)
		//		{
		//			float num7 = Math.Abs(((IntPtr*)(ptr3 + (IntPtr)((ulong)num4 * (ulong)((long)sizeof(Vector3*))) / sizeof(Vector3*)))->X);
		//			float num8 = Math.Abs(((IntPtr*)(ptr3 + (IntPtr)((ulong)num4 * (ulong)((long)sizeof(Vector3*))) / sizeof(Vector3*)))->Y);
		//			float num9 = Math.Abs(((IntPtr*)(ptr3 + (IntPtr)((ulong)num4 * (ulong)((long)sizeof(Vector3*))) / sizeof(Vector3*)))->Z);
		//			uint num10;
		//			if (num7 < num8)
		//			{
		//				if (num8 < num9)
		...
		//				}
		//			}
		//			*(*(IntPtr*)(ptr3 + (IntPtr)((ulong)num5 * (ulong)((long)sizeof(Vector3*))) / sizeof(Vector3*))) = Vector3.Cross(*(*(IntPtr*)(ptr3 + (IntPtr)((ulong)num4 * (ulong)((long)sizeof(Vector3*))) / sizeof(Vector3*))), ptr4[(IntPtr)((ulong)num10 * (ulong)((long)sizeof(Vector3))) / sizeof(Vector3)]);
		//		}
		//		*(*(IntPtr*)(ptr3 + (IntPtr)((ulong)num5 * (ulong)((long)sizeof(Vector3*))) / sizeof(Vector3*))) = Vector3.Normalize(*(*(IntPtr*)(ptr3 + (IntPtr)((ulong)num5 * (ulong)((long)sizeof(Vector3*))) / sizeof(Vector3*))));
		//		if (ptr2[(IntPtr)((ulong)num6 * 4uL) / 4] < 0.0001f)
		//		{
		//			*(*(IntPtr*)(ptr3 + (IntPtr)((ulong)num6 * (ulong)((long)sizeof(Vector3*))) / sizeof(Vector3*))) = Vector3.Cross(*(*(IntPtr*)(ptr3 + (IntPtr)((ulong)num4 * (ulong)((long)sizeof(Vector3*))) / sizeof(Vector3*))), *(*(IntPtr*)(ptr3 + (IntPtr)((ulong)num5 * (ulong)((long)sizeof(Vector3*))) / sizeof(Vector3*))));
		//		}
		//		*(*(IntPtr*)(ptr3 + (IntPtr)((ulong)num6 * (ulong)((long)sizeof(Vector3*))) / sizeof(Vector3*))) = Vector3.Normalize(*(*(IntPtr*)(ptr3 + (IntPtr)((ulong)num6 * (ulong)((long)sizeof(Vector3*))) / sizeof(Vector3*))));
		//		float num11 = identity.GetDeterminant();
		//		if (num11 < 0f)
		//		{
		//			ptr2[(IntPtr)((ulong)num4 * 4uL) / 4] = -(*(ptr2 + (IntPtr)((ulong)num4 * 4uL) / 4));
		//			*(*(IntPtr*)(ptr3 + (IntPtr)((ulong)num4 * (ulong)((long)sizeof(Vector3*))) / sizeof(Vector3*))) = -(*(*(IntPtr*)(ptr3 + (IntPtr)((ulong)num4 * (ulong)((long)sizeof(Vector3*))) / sizeof(Vector3*))));
		//			num11 = -num11;
		//		}
		//		num11 -= 1f;
		//		num11 *= num11;
