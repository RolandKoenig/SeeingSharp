...
namespace FrozenSky.Multimedia.Core
{
    public class ResourceDictionary : IEnumerable<Resource>
    {
            ...
            where T : Resource
        {
            ...
            else if (resourceType == typeof(TextureResource))
            {
                ...
                result = new StandardTextureResource(
                    new AssemblyResourceLink(
                        ...
                        "FrozenSky.Multimedia.Resources.Textures.Blank_16x16.png")) as T;
#endif
            }
            ...
            if (result == null) { throw new FrozenSkyGraphicsException("Unable to create default resource for resource type " + resourceType.FullName); }
            return result;
        }
            ...
            where T : Resource
        {
            ...
            else
            {
                ...
                {
                    throw new FrozenSkyGraphicsException("Resource type mismatch: Behind the requested key " + resourceKey + " is a resource of another type (requested: " + typeof(T).FullName + ", current: " + currentResource.GetType().FullName + ")");
                }
            }
