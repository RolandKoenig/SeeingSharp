    ...
    public abstract class AnimationBase : IAnimation
    {
        ...
        public AnimationUpdateResult Update(UpdateState updateState, AnimationState animationState)
        {
            ...
            switch (m_animationType)
            {
                ...
                case AnimationType.AsyncCall:
                    ...
                    {
                        throw new FrozenSkyGraphicsException("Async animation raised an exception!", m_asyncTask.Exception);
                    }
        ...
        public virtual TimeSpan GetTimeTillNextEvent(TimeSpan previousMinFinishTime, TimeSpan previousMaxFinishTime, TimeSpan defaultCycleTime)
        {
            ...
            switch (this.AnimationType)
            {
                ...
                default:
                    throw new FrozenSkyGraphicsException("Unhandled animation type: " + this.AnimationType);
            }
        }
