...
namespace FrozenSky.Multimedia.Views
{
    public class HigherD3DImageSource : D3DImage, IDisposable
    {
        ...
        public HigherD3DImageSource(EngineDevice device)
        {
            ...
            if(m_d3dDevice == null)
            {
                throw new FrozenSkyException("Unable to create Wpf image source: No Direct3D 9 device available on " + device);
            }
        ...
        public void Dispose()
        {
            ...
            m_d3dRenderTarget = GraphicsHelper.DisposeObject(this.m_d3dRenderTarget);
            s_activeClients--;
        }
