...
namespace FrozenSky.Multimedia.Views
{
    ...
    public partial class FrozenSkyPanelPainter : IFrozenSkyPainter, IDisposable, IInputEnabledView
    {
        ...
        /// </summary>
        /// <param name="targetPanel">The target panel.</param>
        public FrozenSkyPanelPainter(SwapChainBackgroundPanel targetPanel)
            : this()
        {
        ...
        /// </summary>
        /// <param name="targetPanel">The target panel.</param>
        public FrozenSkyPanelPainter(SwapChainPanel targetPanel)
            : this()
        {
            this.Attach(targetPanel);
        }
