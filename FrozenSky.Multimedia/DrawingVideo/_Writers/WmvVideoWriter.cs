...
{
    /// <summary>
    /// This VideoWriter is responsible for writing wmv files to hard disc.
    /// For details see tutorial at: https://msdn.microsoft.com/en-us/library/windows/desktop/ff819477(v=vs.85).aspx
    /// </summary>
    public class WmvVideoWriter : MediaFoundationVideoWriter
    {
        private static readonly Guid VIDEO_ENCODING_FORMAT = MFVideoFormats.FORMAT_WMV3;

        /// <summary>
        /// Initializes a new instance of the <see cref="WmvVideoWriter"/> class.
        /// </summary>
        public WmvVideoWriter()
        {
            this.FileNameTemplate = "Video_{0}.wmv";
        }
