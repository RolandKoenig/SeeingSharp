...
namespace FrozenSky.Multimedia.Objects
{
    internal class SimplePolygon2DGeometrySink : GeometrySink
    {
        ...
        /// <exception cref="FrozenSkyException"></exception>
        public void AddArc(ArcSegment arc)
        {
            throw new FrozenSkyGraphicsException("Geometry type 'Arc' not supported for text geometry building!");
        }
        ...
        {
            throw new FrozenSkyGraphicsException("Geometry type 'Bezier' not supported for text geometry building!");
        }
        ...
        {
            throw new FrozenSkyGraphicsException("Geometry type 'QuadricBezier' not supported for text geometry building!");
        }
        ...
        {
            throw new FrozenSkyGraphicsException("Geometry type 'QuadricBeziers' not supported for text geometry building!");
        }
        ...
        {
            throw new FrozenSkyGraphicsException("Geometry type 'Beziers' not supported for text geometry building!");
        }
