...
namespace FrozenSky.Multimedia.Objects
{
    public class ImportExportHandler
    {
        ...
        /// <summary>
        /// Prevents a default instance of the <see cref="ImportExportHandler"/> class from being created.
        /// </summary>
        internal ImportExportHandler()
        {
            m_importers = FrozenSkyApplication.Current.TypeQuery
                .GetAndInstanciateByContract<IModelImporter>();
            m_exporters = FrozenSkyApplication.Current.TypeQuery
