...
namespace FrozenSky.Util
{
    public partial class PerformanceAnalyzer
    {
        ...
        public Task RunAsync(CancellationToken cancelToken)
        {
            ...
            {
                throw new FrozenSkyException("Unable to start OnlineKpiContainer: Main loop is already running!");
            }
            ...
            where T : PerformanceCalculatorBase
        {
            ...
            {
                throw new FrozenSkyException("Unable to create a calculator of type " + typeof(T) + " for activity " + activity + "!");
            }
