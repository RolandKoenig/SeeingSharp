    ...
    public class CustomLazy<T>
    {
        ...
        public T Value
        {
            get
            {
                ...
                if (m_asyncLoadException != null) { throw new FrozenSkyException("Unhandled exception while loading object of type " + typeof(T).FullName + ": " + m_asyncLoadException.Message, m_asyncLoadException); }
