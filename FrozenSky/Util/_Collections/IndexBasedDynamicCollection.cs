...
namespace FrozenSky.Util
{
        ...
        where T : class
    {
        ...
        public int AddObject(T objectToAdd)
        {
            lock (m_lockObject)
            {
                if (m_objectIndices.ContainsKey(objectToAdd)) { throw new FrozenSkyException("This object is already added!"); }
        ...
        public void AddObject(T objectToAdd, int index, bool throwIfIndexAlreadyUsed)
        {
            ...
            {
                if (throwIfIndexAlreadyUsed) { throw new FrozenSkyException("There is already an object at the given index!"); }
            ...
            lock (m_lockObject)
            {
                ...
                {
                    throw new FrozenSkyException("This object is already added!");
                }
