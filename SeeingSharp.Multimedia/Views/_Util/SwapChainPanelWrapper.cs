...
namespace SeeingSharp.Multimedia.Views
{
    internal class SwapChainPanelWrapper : IDisposable
    {
        ...
        public void Dispose()
        {
            GraphicsHelper.SafeDispose(ref m_bgPanelNative);
            GraphicsHelper.SafeDispose(ref m_panelNative);
        }

        private void OnAnyPanel_Unloaded(object sender, RoutedEventArgs e)
        {
            this.Unloaded.Raise(sender, e);
        }

        private void OnAnyPanel_Loaded(object sender, RoutedEventArgs e)
        {
            this.Loaded.Raise(sender, e);
        }
        ...
        {
            get { return this.Panel.ActualWidth; }
        }

        public double ActualHeight
        {
            get { return this.Panel.ActualHeight; }
        }
