...
namespace SeeingSharp.Multimedia.Objects
{
    public class Overlay2DLineObject : SceneObject
    {
        ...
        {
            using(D2D.SolidColorBrush brush = new D2D.SolidColorBrush(renderState.RenderTarget2D, Color4.RedColor.ToDXColor()))
            {
                renderState.RenderTarget2D.DrawLine(
                    new SharpDX.Vector2(10f, 10f),
                    new SharpDX.Vector2(200f, 200f),
                    brush,
                    10f);
                ...
                {
                    renderState.RenderTarget2D.DrawLine(
                        new SharpDX.Vector2(200f + 10f * loop, 10f),
                        new SharpDX.Vector2(200f + 10f * loop, 200f),
                        brush,
                        5f);
                }
            }
